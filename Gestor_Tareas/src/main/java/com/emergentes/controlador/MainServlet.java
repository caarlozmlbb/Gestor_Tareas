...
import com.emergentes.clases.Tarea;
...
public class MainServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession ses = request.getSession();//optener la session
        ArrayList<Tarea> lista = (ArrayList<Tarea>)ses.getAttribute("listaper");

        switch(op){
            case "nuevo":
                //Enviar un objeto vacio a esitar
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("listaper",lista);//Actualizar la lista
